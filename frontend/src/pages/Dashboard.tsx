    ...
    >
      <Box
        sx={{
          ...
          boxShadow:
            status === "running" ? `0 0 10px ${colors[status]}` : "none",
        }}
      >
        {status === "running" && (
          <Box
      ...
      <Typography
        variant="caption"
        sx={{ color: status === "pending" ? "text.disabled" : "text.primary" }}
      >
        {label}
      </Typography>
    </Box>
        ...
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            {isAdmin
              ...
              : "Public View • Read-Only Mode"}
          </Typography>
        </Box>
        <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
          {/* No offline or warning chip for mock/fallback mode, keep UI clean */}
          {isAdmin && (
            <Chip
              icon={<Unlock size={16} />}
              label="Admin"
            ...
            >
              ...
              >
                <Typography variant="h6" fontWeight={700}>
                  Market Trend & Strategy Performance
                </Typography>
          ...
          <Stack spacing={3}>
            ...
            >
              <CardContent>
                ...
                >
                  Last training:{" "}
                  {new Date(pipeline.last_retrained).toLocaleTimeString()}
                </Typography>
              </CardContent>
            </Card>
