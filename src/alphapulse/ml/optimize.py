...
def optimize(
    ...
    study = optuna.create_study(
        direction='maximize',
        study_name='xgboost_btc_optimization'
    )
    ...
    try:
        ...
        with mlflow.start_run(run_name="optuna_best"):
            ...
            mlflow.log_metric("total_return", best_trial.user_attrs.get('total_return', 0))
            mlflow.log_metric("max_drawdown", best_trial.user_attrs.get('max_drawdown', 0))
