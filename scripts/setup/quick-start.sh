...
show_urls() {
    ...
    echo -e "${BLUE}════════════════════════════════════════════════════════════════${NC}"
    echo ""
    echo -e "${GREEN}FastAPI Docs:${NC}      http://localhost:8000/api/docs"
    echo -e "${GREEN}Airflow UI:${NC}        http://localhost:8080"
    echo -e "${GREEN}MLflow:${NC}           http://localhost:5002"
...
case "${1:-start}" in
    start)
        ...
        echo -e "  1. Open FastAPI docs: ${GREEN}http://localhost:8000/api/docs${NC}"
